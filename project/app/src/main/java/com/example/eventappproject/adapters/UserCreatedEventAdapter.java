...
public class UserCreatedEventAdapter extends RecyclerView.Adapter<UserCreatedEventAdapter.ViewHolder> {
    private List<Event> events;
    private UserCreatedEventRecyclerViewInterface userCreatedEventInterface;

    public UserCreatedEventAdapter(List<Event> events, UserCreatedEventRecyclerViewInterface userCreatedEventInterface) {
        this.events = events;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        UserCreatedEventAdapter.ViewHolder viewHolder = new UserCreatedEventAdapter.ViewHolder(eventView);
        return viewHolder;
    }
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (userCreatedEventInterface != null && position != RecyclerView.NO_POSITION) {
                        userCreatedEventInterface.onCreatedEventItemClick(position);
                    }
                }
            });
        }
